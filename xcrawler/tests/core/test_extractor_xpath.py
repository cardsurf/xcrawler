...
class TestExtractorXPath(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.extractor_xpath = ExtractorXPath(root_element, fallbacklist_factory, string_converter)
    ...
    def test_xpath(self):
        ...
        self.extractor_xpath.fallbacklist_factory.create_fallback_list.return_value = mock_result_fallback_list
